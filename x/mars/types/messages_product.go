...
func NewMsgCreateProduct(creator string, productID string, description string, owner string, price string) *MsgCreateProduct {
...
func NewMsgUpdateProduct(creator string, id uint64, productID string, description string, owner string, price string) *MsgUpdateProduct {
