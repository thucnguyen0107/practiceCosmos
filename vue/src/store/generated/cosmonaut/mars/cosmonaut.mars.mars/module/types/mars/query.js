...
export class QueryClientImpl {
    ...
    Params(request) {
        ...
        const promise = this.rpc.request("cosmonaut.mars.mars.Query", "Params", data);
        return promise.then((data) => QueryParamsResponse.decode(new Reader(data)));
    }
    Product(request) {
        const data = QueryGetProductRequest.encode(request).finish();
        const promise = this.rpc.request("cosmonaut.mars.mars.Query", "Product", data);
    ...
    ProductAll(request) {
        ...
        const promise = this.rpc.request("cosmonaut.mars.mars.Query", "ProductAll", data);
