...
const baseMsgBuyProduct = { creator: "", productID: "" };
export const MsgBuyProduct = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMsgBuyProduct };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseMsgBuyProductResponse = {};
export const MsgBuyProductResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMsgBuyProductResponse };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                default:
...
export class MsgClientImpl {
    ...
    BuyProduct(request) {
        ...
        const promise = this.rpc.request("cosmonaut.mars.mars.Msg", "BuyProduct", data);
        return promise.then((data) => MsgBuyProductResponse.decode(new Reader(data)));
    }
}
var globalThis = (() => {
